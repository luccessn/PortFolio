...
const Greenalert = () => {
  ...
  return (
    isVisible && (
      <div>
        {" "}
        <div className="flex flex-col gap-2 w-60 sm:w-72 text-[10px] sm:text-xs z-50 relative -top-[65em] ssm:-top-[75em] sm:-top-[28em] sm:-left-[20em] md:-top-[30em] md:-left-[25em] ssm:left-[15em] xxl:-top-[33em]">
